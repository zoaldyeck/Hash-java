...
public class Main {
	...
	//for(int i=0;i<StringTable.table.length;++i)
	//	if(StringTable.table[i]!=null)
	//	System.out.println(i+","+StringTable.table[i].key);
	findMatches(table, corpusSeq, matchLength);
	//System.out.println("After deleted____________");
	//for(int i=0;i<StringTable.table.length;++i)
	//	if(StringTable.table[i]!=null)
	//	System.out.println(i+","+StringTable.table[i].key);
    }
	...
	for (int j = 0; j < corpusSeq.length() - matchLength + 1; j++)
		...
		//System.out.println("The key we are looking for:");
	//	System.out.println(key);
		Record rec = table.find(key);
		//System.out.println("The key we found:");
